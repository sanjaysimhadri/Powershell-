...
function getMockEndpoint(scheme, msiClientId) {
    ...
    var endpoint = {
        ...
        applicationTokenCredentials: new azure_arm_common_1.ApplicationTokenCredentials("MOCK_SPN_ID", "MOCK_TENANT_ID", "MOCK_SPN_KEY", "https://management.azure.com/", "https://login.windows.net/", "https://management.azure.com/", false, scheme, msiClientId)
    };
    exports.nock("https://login.windows.net", {
        reqheaders: {
...
function mockAzureARMAppInsightsWebTests() {
    ...
    exports.nock('https://management.azure.com', {
        reqheaders: {
...
function mockKuduServiceTests() {
    ...
    exports.nock('http://MOCK_SCM_WEBSITE').delete('/api/vfs/site/wwwroot/hello.txt').reply(200);
    exports.nock('http://FAIL_MOCK_SCM_WEBSITE').delete('/api/vfs/site/wwwroot/web.config').reply(501, 'Internal error occured');
    exports.nock('http://MOCK_SCM_WEBSITE').
    ...
    exports.nock('http://MOCK_SCM_WEBSITE.scm.azurewebsites.net').
    ...
    exports.nock('http://FAIL_MOCK_SCM_WEBSITE.scm.azurewebsites.net').
